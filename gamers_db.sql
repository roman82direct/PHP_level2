...
--
-- Хост: 127.0.0.1:3307
-- Время создания: Ноя 24 2020 г., 21:35
...
(101, 9, 2, 90, NULL, NULL),
(102, 9, 3, 110, NULL, NULL);
...
INSERT INTO `goods` (`id_good`, `name`, `price`, `catalogImg`, `id_category`, `status`) VALUES
(1, 'Assassins CREED', 100, 'Assasin.jpg', NULL, NULL),
(2, 'Tomb Rider', 90, 'tombrider.jpg', NULL, NULL),
(3, 'World Of Tanks', 110, 'galwoft.png', NULL, NULL),
(4, 'Call Of Duty', 120, 'galcallofd.png', NULL, NULL),
(5, 'HITMAN', 105, 'simhit.png', NULL, NULL),
(6, 'World of Warships', 130, 'galWorld_of_Warships.png', NULL, NULL),
(7, 'Ryse', 110, 'ryse.jpg', NULL, NULL),
(8, 'Battlefield 1', 130, 'galbattfield1.png', NULL, NULL);
...
--
ALTER TABLE `basket`
  MODIFY `id_basket` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
...
--
ALTER TABLE `goods`
  MODIFY `id_good` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
